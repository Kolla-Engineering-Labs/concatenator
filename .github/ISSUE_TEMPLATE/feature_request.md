...
- [ ] Developers using LLMs (providing context)
- [ ] Code reviewers (managing multi-file reviews)
- [ ] Documentation writers (combining source files)
...
- **Security Implications**: <!-- Any security concerns to consider? -->
...
Note: Concatenator relies on the File System Access API, which has varying support across browsers. Knowing your primary browser helps us assess feasibility.
...
- [ ] I cannot implement this feature myself
...
- [ ] I have considered how this feature affects both concatenate and de-concatenate modes
