...
- **steal** — we lack it and it advances our core. Steal the _pattern_, not the storage engine: re-express in our primitives, never vendor their runtime.
...
- **Independently checked, not self-report.** Get facts on _how_ they implement
...
- [ ] Facts on _how_ they implement come from code and a fresh independent check — not a README.
