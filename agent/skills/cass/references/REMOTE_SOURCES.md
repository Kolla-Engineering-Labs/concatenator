...
- Path mappings rewrite _workspace_ paths only. The `source_path` of remote hits still references the **remote** filesystem — pass back to the user verbatim, don't try to open them locally.
