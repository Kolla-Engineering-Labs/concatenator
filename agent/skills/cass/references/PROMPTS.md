...
> **Source:** Real prompts from this user's session corpus that have been _re-used 5+ times_. These are tested, working entry points to cass — copy/paste, then adapt the keyword.
...
These prompts trigger /cass but produce _poor_ results — rewrite them before executing:
