...
- [Gemini CLI Format](#gemini-cli-format)
- [Subagent Sessions (Critical)](#subagent-sessions-critical)
- [Universal Extraction Patterns](#universal-extraction-patterns)
- [File Location Cheat Sheet](#file-location-cheat-sheet)
