...
RCH ships a stable error catalog of 94 codes in the `RCH-Exxx` namespace. Every user-visible failure that is _expected and explainable_ carries one of these codes. They appear in:
