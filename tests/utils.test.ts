...
describe('cn utility function', () => {
  ...
  it('filters out falsy values', () => {
    ...
    const result = cn('class1', shouldShow && 'class2', 'class3', null, undefined, 0, '');
  ...
  it('handles dark mode classes', () => {
    const result = cn('bg-white', 'dark:bg-slate-900', 'text-slate-900', 'dark:text-white');
    expect(result).toBe('bg-white dark:bg-slate-900 text-slate-900 dark:text-white');
  });
