...
try {
  ...
  console.log(`✓ [KEL Protocol] Single Executable Application compiled: dist/${binaryName}`);
} catch (error) {
  console.error('✗ [KEL Protocol] Fatal error during SEA compilation:', (error as Error).message);
  process.exit(1);
}
